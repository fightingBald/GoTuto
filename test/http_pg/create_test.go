...
func TestCreateProduct_Postgres(t *testing.T) {
    ...
    t.Run("create 201", func(t *testing.T) {
        ...
        if err != nil { t.Fatalf("http post: %v", err) }
    ...
    t.Run("get 200", func(t *testing.T) {
        ...
        if err := json.NewDecoder(resp2.Body).Decode(&fetched); err != nil { t.Fatalf("decode fetched: %v", err) }
    ...
    t.Run("delete 204", func(t *testing.T) {
        ...
        if err != nil { t.Fatalf("http delete: %v", err) }
        resp3.Body.Close()
    ...
    t.Run("get after delete 404", func(t *testing.T) {
        ...
        if err != nil { t.Fatalf("http get after delete: %v", err) }
        resp4.Body.Close()
